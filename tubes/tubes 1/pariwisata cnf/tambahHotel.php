                ...
                <div class="form-login mt-5">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="hotel" id="hotel" class="form-control" autocomplete="off" required placeholder="Hotel">
                        </div>
                        <div class="mb-3">
                            <label for="harga" class="form-label">Harga :</label>
                            <input type="text" name="harga" id="harga" class="form-control" autocomplete="off" required placeholder="Masukkan Harga">
                        </div>
                        <div class="mb-3">
                            <label for="max" class="form-label">Maximal Menginap :</label>
                            <input type="text" name="max" id="max" class="form-control" autocomplete="off" required placeholder="Max-Menginap">
                        </div>
